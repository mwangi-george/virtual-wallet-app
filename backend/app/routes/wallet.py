...
def create_wallet_router() -> APIRouter:
    ...
    async def deposit(data: DepositRequest,
        ...
        response = wallet_services.deposit_funds(user, data, db)
        return response
    ...
    async def withdraw(data: WithdrawRequest,
        ...
        response = wallet_services.withdraw_funds(user, data, db)
        return response
    ...
    async def transfer(data: TransferRequest,
        ...
        response = wallet_services.transfer_funds(user, data, db)
        return response
    ...
    async def transact(data: PurchaseRequest,
        ...
        response = wallet_services.buy_goods(user, data, db)
        return response
    ...
    async def check_account_balance(user: User = Depends(security.get_current_user),
        ...
        response = wallet_services.get_balance(user, db)
        return response
